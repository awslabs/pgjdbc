...
package software.aws.rds.jdbc.postgresql.osgi;
...
import software.aws.rds.jdbc.postgresql.ds.PGSimpleDataSource;
import software.aws.rds.jdbc.postgresql.ds.PGPoolingDataSource;
import software.aws.rds.jdbc.postgresql.ds.PGConnectionPoolDataSource;
import software.aws.rds.jdbc.postgresql.xa.PGXADataSource;
...
public class PGDataSourceFactory implements DataSourceFactory {
  ...
  public java.sql.Driver createDriver(Properties props) throws SQLException {
    ...
    return new software.aws.rds.jdbc.postgresql.Driver();
  }
